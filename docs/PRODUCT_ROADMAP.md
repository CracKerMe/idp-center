...
> 已在 P0 第一阶段实现。详见 [安全专题文档](security/password-policy.md) · [API 文档](api/password-policy-api.md)
...
> 已在 P0 第一阶段实现。详见 [安全专题文档](security/ip-whitelist.md) · [API 文档](api/ip-whitelist-api.md)
...
- **OIDC Back-Channel Logout**：由 IDP 后端节点直接向接入侧业务系统后台派发 Webhook 销毁通知（高可靠且适应无浏览器及离线端点）。
