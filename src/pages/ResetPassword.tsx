    ...
    <div className="min-h-screen bg-zinc-50 dark:bg-zinc-950 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      ...
      <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
        <div className="bg-white dark:bg-zinc-900 py-8 px-4 shadow sm:rounded-lg sm:px-10">
          {step === 'verifying' && (
            <p className="text-center text-sm text-zinc-500 dark:text-zinc-400">Verifying your reset token...</p>
          )}
          ...
          {step === 'success' && (
            <div className="text-center">
              ...
              <h3 className="text-lg font-medium text-zinc-900 dark:text-white">Password reset successful</h3>
              <p className="mt-2 text-sm text-zinc-500 dark:text-zinc-400">You can now sign in with your new password.</p>
              <div className="mt-6">
                ...
                {passwordStrength && (
                  <div className="mt-2">
                    <div className="flex items-center gap-2 mb-1">
                      ...
                      <span className="text-xs text-zinc-500 dark:text-zinc-400">{getStrengthLabel()}</span>
                    </div>
