    ...
    <div>
      ...
      <div className="mt-4 relative">
        ...
        <input
          ...
          className="pl-10 w-full max-w-md px-3 py-2 border border-zinc-300 rounded-md shadow-sm focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
        />
      </div>
              ...
              <table className="min-w-full divide-y divide-zinc-300">
                <thead className="bg-zinc-50">
                  <tr>
                    ...
                    <th scope="col" className="px-3 py-3.5 text-left text-sm font-semibold text-zinc-900">Domain</th>
                    <th scope="col" className="px-3 py-3.5 text-left text-sm font-semibold text-zinc-900">Status</th>
                    <th scope="col" className="px-3 py-3.5 text-left text-sm font-semibold text-zinc-900">Created</th>
                ...
                <tbody className="divide-y divide-zinc-200 bg-white">
                  {loading ? (
                    <tr>
                      <td colSpan={5} className="py-10 text-center text-sm text-zinc-500">Loading...</td>
                    </tr>
                  ) : filteredTenants.length === 0 ? (
                    <tr>
                      <td colSpan={5} className="py-10 text-center text-sm text-zinc-500">No tenants found</td>
                    </tr>
                  ) : (
                    filteredTenants.map((tenant) => (
                      <tr key={tenant.id}>
                        ...
                        <td className="whitespace-nowrap px-3 py-4 text-sm text-zinc-500">{tenant.domain || '-'}</td>
                        <td className="whitespace-nowrap px-3 py-4 text-sm">
                          {tenant.is_active ? (
                            ...
                            <span className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-zinc-100 text-zinc-800">
                ...
                <div className="space-y-4">
                  ...
                  {editingTenant && (
                    <div className="flex items-center">
                      ...
                      />
                      <label htmlFor="is_active" className="ml-2 block text-sm text-zinc-900">
                        Active
                      </label>
                    </div>
                  )}
