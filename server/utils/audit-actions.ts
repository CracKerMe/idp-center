...
export const AuditAction = {
  ...
  // Risk engine / UEBA (phase 3)
  RISK_LOGIN_CHALLENGED: 'RISK_LOGIN_CHALLENGED',
  RISK_LOGIN_DENIED: 'RISK_LOGIN_DENIED',
  RISK_SESSION_REVOKED: 'RISK_SESSION_REVOKED',
  RISK_POLICY_CREATED: 'RISK_POLICY_CREATED',
  RISK_POLICY_UPDATED: 'RISK_POLICY_UPDATED',
  RISK_POLICY_DELETED: 'RISK_POLICY_DELETED',

  // LLM-assisted admin tooling (phase 3.3)
  AI_POLICY_DRAFT_GENERATED: 'AI_POLICY_DRAFT_GENERATED',
...
export const ANOMALY_ACTIONS: readonly AuditActionName[] = [
  ...
  AuditAction.RISK_LOGIN_CHALLENGED, AuditAction.RISK_LOGIN_DENIED, AuditAction.RISK_SESSION_REVOKED,
];
